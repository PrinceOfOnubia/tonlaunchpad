...
export function launchToToken(launch: Launch) {
  return {
    ...
    platformFees: {
      ...
      tokenFeeAmount: launch.platformTokenFeeAmount,
      tokenFeeTonTreasuryShare: launch.platformTokenFeeTonTreasuryShare,
      tokenFeeTokenTreasuryShare: launch.platformTokenFeeTokenTreasuryShare,
      liquidityTonAmount: launch.liquidityTonAmount,
      creatorTreasuryAmount: launch.creatorTreasuryAmount,
      payoutPlatformTonTreasury: launch.payoutPlatformTonTreasury,
      payoutPlatformTokenTreasury: launch.payoutPlatformTokenTreasury,
      payoutLiquidityTreasury: launch.payoutLiquidityTreasury,
    },
